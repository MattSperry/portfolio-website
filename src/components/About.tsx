      ...
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
        <div className="md:w-1/3 mb-8 md:mb-0 md:mr-12 flex justify-center">
          <img 
            ...
            alt="Matthew Sperry" 
            className="rounded-full w-48 h-48 md:w-64 md:h-64 object-cover border-4 border-blue-500 dark:border-blue-400 shadow-md"
          />
        </div>
        <div className="md:w-2/3 text-center md:text-left">
          <h2 className="text-3xl font-bold mb-4 text-blue-600 dark:text-blue-400">About Me</h2>
          <p className="text-lg mb-4 text-gray-700 dark:text-gray-300">
            I am Matthew Sperry, a passionate technologist with a Bachelor of Science in Information Systems from Brigham Young University's Marriott School of Business. My focus lies in leveraging my skills in coding and artificial intelligence to create effective and innovative technology solutions.
          </p>
